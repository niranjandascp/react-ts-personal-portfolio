...
const SPECIFIC_REPOS: Repo[] = [
  {
    name: 'node-express-jwt-auth-restapi',
    description:
    ...
    html_url: 'https://github.com/niranjandascp/node-express-jwt-auth-restapi',
  },
  {
    ...
    html_url: 'https://github.com/niranjandascp/react-ts-personal-portfolio',
  },
  {
    name: 'rest-api-ts-docker',
    description:
    ...
    forks: 1,
    language: 'Node.js, TypeScript',
    html_url: 'https://github.com/niranjandascp/rest-api-ts-docker',
  },
];
...
export function GitHub() {
  ...
  useEffect(() => {
    fetch('https://api.github.com/users/niranjandascp')
      .then(res => res.json())
